<?php
/*
Template Name: Automotive Repair
*/
 get_header();  ?>
<products>
      ...
      <div class="row">
         ...
         <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="products_text">
               ...
               <h1>   
                  Automative <span class="span">Repair</span>
               </h1>
               <p>
                Automotive Repair means the use of any building or structure and associated premises on which a business, service, or 
   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 ">
            <div class="card">
              <img src="<?php echo get_template_directory_uri(); ?>/resources/images/automotive (1).jpg">
              <div class="card_text">
         ...
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/resources/images/automotive (2).jpg">           
            </div>
         </div>
      </div>
   </div>
