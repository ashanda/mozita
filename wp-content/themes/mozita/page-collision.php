      ...
      <div class="row">
         ...
         <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="products_text">
               ...
               <h1>   
                  Collision Repair <span class="span">& Paint</span>
               </h1>
               <p>
                Collision repair means restoration or repair of damage to a motor vehicle resulting from collision or other occurrence.
                They remove any damaged body parts, realign car frames, and repair structural damage. Their job includes hammering out 
                or patching dents, dimples, or other minor body damage. These professionals also fit, attach, and weld replacement parts into place.
               </p>
               <p>
   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 ">
            <div class="card">
              <img src="<?php echo get_template_directory_uri(); ?>/resources/images/collision (3).jpg">
              <div class="card_text">
         ...
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/resources/images/collision (4).jpg">           
            </div>
         </div>
      </div>
   </div>
...
<products>
   <div class="container-fluid">
      <div class="row">
         ...
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <img src="<?php echo get_template_directory_uri(); ?>/resources/images/product (2).jpg">
         </div>
      </div>
   </div>
</products-->
