      ...
      <div class="row">
         ...
         <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="products_text">
               ...
               <h1>   
                  Hybrid <span class="span">Repair</span>
               </h1>
               <p>
                Like any car, a hybrid needs regular maintenance to keep it running at its best and occasionally needs a replacement part. Most of the standard maintenance of a hybrid is getting oil changes on time. And like any car, they occasionally need a new battery to replace a bad one.               </p>
               <p>
                ...
                shape and running at top speed in no time.              </p>
   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 ">
            <div class="card">
              <img src="<?php echo get_template_directory_uri(); ?>/resources/images/hybrid (1).jpg">
              <div class="card_text">
                  <h1>We fix weak batteries</h1>
              </div>
            </div>
         </div>
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
               <div class="card_text">
                  <h1>Evaporative Emissions System</h1>
              </div>
              <img src="<?php echo get_template_directory_uri(); ?>/resources/images/hybrid (2).jpg">           
            </div>
         </div>
      </div>
   </div>
